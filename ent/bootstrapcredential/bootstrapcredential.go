...
const (
	// Label holds the string label denoting the bootstrapcredential type in the database.
	Label = "bootstrap_credential"
	...
	FieldUsedAt = "used_at"
	// Table holds the table name of the bootstrapcredential in the database.
	Table = "bootstrap_credentials"
)

// Columns holds all SQL columns for bootstrapcredential fields.
var Columns = []string{
	FieldID,
	FieldTokenHash,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the BootstrapCredential queries.
