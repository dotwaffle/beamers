...
func (_u *EventUpdate) AddEventAwardsDraftIDs(ids ...int) *EventUpdate {
	_u.mutation.AddEventAwardsDraftIDs(ids...)
	return _u
}

// AddEventAwardsDrafts adds the "event_awards_drafts" edges to the EventAwardsDraft entity.
func (_u *EventUpdate) AddEventAwardsDrafts(v ...*EventAwardsDraft) *EventUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *EventUpdate) AddPrizegivingCompetitionIDs(ids ...int) *EventUpdate {
	_u.mutation.AddPrizegivingCompetitionIDs(ids...)
	return _u
}

// AddPrizegivingCompetitions adds the "prizegiving_competitions" edges to the PrizegivingCompetition entity.
func (_u *EventUpdate) AddPrizegivingCompetitions(v ...*PrizegivingCompetition) *EventUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEventAwardsDrafts clears all "event_awards_drafts" edges to the EventAwardsDraft entity.
func (_u *EventUpdate) ClearEventAwardsDrafts() *EventUpdate {
	_u.mutation.ClearEventAwardsDrafts()
	return _u
}

// RemoveEventAwardsDraftIDs removes the "event_awards_drafts" edge to EventAwardsDraft entities by IDs.
func (_u *EventUpdate) RemoveEventAwardsDraftIDs(ids ...int) *EventUpdate {
	_u.mutation.RemoveEventAwardsDraftIDs(ids...)
	return _u
}

// RemoveEventAwardsDrafts removes "event_awards_drafts" edges to EventAwardsDraft entities.
func (_u *EventUpdate) RemoveEventAwardsDrafts(v ...*EventAwardsDraft) *EventUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPrizegivingCompetitions clears all "prizegiving_competitions" edges to the PrizegivingCompetition entity.
func (_u *EventUpdate) ClearPrizegivingCompetitions() *EventUpdate {
	_u.mutation.ClearPrizegivingCompetitions()
	return _u
}

// RemovePrizegivingCompetitionIDs removes the "prizegiving_competitions" edge to PrizegivingCompetition entities by IDs.
func (_u *EventUpdate) RemovePrizegivingCompetitionIDs(ids ...int) *EventUpdate {
	_u.mutation.RemovePrizegivingCompetitionIDs(ids...)
	return _u
}

// RemovePrizegivingCompetitions removes "prizegiving_competitions" edges to PrizegivingCompetition entities.
func (_u *EventUpdate) RemovePrizegivingCompetitions(v ...*PrizegivingCompetition) *EventUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *EventUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.EventAwardsDraftsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   event.EventAwardsDraftsTable,
			Columns: []string{event.EventAwardsDraftsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedEventAwardsDraftsIDs(); len(nodes) > 0 && !_u.mutation.EventAwardsDraftsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   event.EventAwardsDraftsTable,
	...
	if nodes := _u.mutation.EventAwardsDraftsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   event.EventAwardsDraftsTable,
	...
	if _u.mutation.PrizegivingCompetitionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedPrizegivingCompetitionsIDs(); len(nodes) > 0 && !_u.mutation.PrizegivingCompetitionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   event.PrizegivingCompetitionsTable,
	...
	if nodes := _u.mutation.PrizegivingCompetitionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   event.PrizegivingCompetitionsTable,
...
// AddEventAwardsDraftIDs adds the "event_awards_drafts" edge to the EventAwardsDraft entity by IDs.
func (_u *EventUpdateOne) AddEventAwardsDraftIDs(ids ...int) *EventUpdateOne {
	_u.mutation.AddEventAwardsDraftIDs(ids...)
	return _u
}

// AddEventAwardsDrafts adds the "event_awards_drafts" edges to the EventAwardsDraft entity.
func (_u *EventUpdateOne) AddEventAwardsDrafts(v ...*EventAwardsDraft) *EventUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPrizegivingCompetitionIDs adds the "prizegiving_competitions" edge to the PrizegivingCompetition entity by IDs.
func (_u *EventUpdateOne) AddPrizegivingCompetitionIDs(ids ...int) *EventUpdateOne {
	_u.mutation.AddPrizegivingCompetitionIDs(ids...)
	return _u
}

// AddPrizegivingCompetitions adds the "prizegiving_competitions" edges to the PrizegivingCompetition entity.
func (_u *EventUpdateOne) AddPrizegivingCompetitions(v ...*PrizegivingCompetition) *EventUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearEventAwardsDrafts clears all "event_awards_drafts" edges to the EventAwardsDraft entity.
func (_u *EventUpdateOne) ClearEventAwardsDrafts() *EventUpdateOne {
	_u.mutation.ClearEventAwardsDrafts()
	return _u
}

// RemoveEventAwardsDraftIDs removes the "event_awards_drafts" edge to EventAwardsDraft entities by IDs.
func (_u *EventUpdateOne) RemoveEventAwardsDraftIDs(ids ...int) *EventUpdateOne {
	_u.mutation.RemoveEventAwardsDraftIDs(ids...)
	return _u
}

// RemoveEventAwardsDrafts removes "event_awards_drafts" edges to EventAwardsDraft entities.
func (_u *EventUpdateOne) RemoveEventAwardsDrafts(v ...*EventAwardsDraft) *EventUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPrizegivingCompetitions clears all "prizegiving_competitions" edges to the PrizegivingCompetition entity.
func (_u *EventUpdateOne) ClearPrizegivingCompetitions() *EventUpdateOne {
	_u.mutation.ClearPrizegivingCompetitions()
	return _u
}

// RemovePrizegivingCompetitionIDs removes the "prizegiving_competitions" edge to PrizegivingCompetition entities by IDs.
func (_u *EventUpdateOne) RemovePrizegivingCompetitionIDs(ids ...int) *EventUpdateOne {
	_u.mutation.RemovePrizegivingCompetitionIDs(ids...)
	return _u
}

// RemovePrizegivingCompetitions removes "prizegiving_competitions" edges to PrizegivingCompetition entities.
func (_u *EventUpdateOne) RemovePrizegivingCompetitions(v ...*PrizegivingCompetition) *EventUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
