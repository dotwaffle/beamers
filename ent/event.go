...
type Event struct {
	...
	// VotingMethod holds the value of the "voting_method" field.
	VotingMethod event.VotingMethod `json:"voting_method,omitempty"`
	// SelfVotePolicy holds the value of the "self_vote_policy" field.
	SelfVotePolicy event.SelfVotePolicy `json:"self_vote_policy,omitempty"`
...
type EventEdges struct {
	...
	// Prizegivings holds the value of the prizegivings edge.
	Prizegivings []*Prizegiving `json:"prizegivings,omitempty"`
	// PrizegivingCompetitions holds the value of the prizegiving_competitions edge.
	PrizegivingCompetitions []*PrizegivingCompetition `json:"prizegiving_competitions,omitempty"`
	// ResultsPublications holds the value of the results_publications edge.
	ResultsPublications []*ResultsPublication `json:"results_publications,omitempty"`
	// ResultsCorrections holds the value of the results_corrections edge.
...
// was not loaded in eager-loading.
func (e EventEdges) VotesOrErr() ([]*Vote, error) {
	if e.loadedTypes[17] {
		return e.Votes, nil
	}
...
// was not loaded in eager-loading.
func (e EventEdges) VotingTalliesOrErr() ([]*VotingTally, error) {
	if e.loadedTypes[18] {
...
// QueryPrizegivings queries the "prizegivings" edge of the Event entity.
func (_m *Event) QueryPrizegivings() *PrizegivingQuery {
	return NewEventClient(_m.config).QueryPrizegivings(_m)
}

// QueryPrizegivingCompetitions queries the "prizegiving_competitions" edge of the Event entity.
func (_m *Event) QueryPrizegivingCompetitions() *PrizegivingCompetitionQuery {
	return NewEventClient(_m.config).QueryPrizegivingCompetitions(_m)
}

// QueryResultsPublications queries the "results_publications" edge of the Event entity.
func (_m *Event) QueryResultsPublications() *ResultsPublicationQuery {
	return NewEventClient(_m.config).QueryResultsPublications(_m)
}

// QueryResultsCorrections queries the "results_corrections" edge of the Event entity.
func (_m *Event) QueryResultsCorrections() *ResultsCorrectionQuery {
	return NewEventClient(_m.config).QueryResultsCorrections(_m)
}
...
// QueryVotes queries the "votes" edge of the Event entity.
func (_m *Event) QueryVotes() *VoteQuery {
	return NewEventClient(_m.config).QueryVotes(_m)
}

// QueryVotingTallies queries the "voting_tallies" edge of the Event entity.
func (_m *Event) QueryVotingTallies() *VotingTallyQuery {
	return NewEventClient(_m.config).QueryVotingTallies(_m)
}
