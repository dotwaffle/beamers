...
const (
	...
	// FieldResultsCorrectionRevision holds the string denoting the results_correction_revision field in the database.
	FieldResultsCorrectionRevision = "results_correction_revision"
...
var Columns = []string{
	...
	FieldRenderedText,
	FieldRenderedJSON,
	FieldResultsCorrectionRevision,
...
var (
	...
	// ResultsCorrectionRevisionValidator is a validator for the "results_correction_revision" field. It is called by the builders before save.
	ResultsCorrectionRevisionValidator func(int) error
...
func ScopeValidator(s Scope) error {
	switch s {
	case ScopePrizegiving, ScopeStandalone, ScopeEventAwards, ScopeEvent:
		return nil
	default:
...
// ByResultsCorrectionRevision orders the results by the results_correction_revision field.
func ByResultsCorrectionRevision(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldResultsCorrectionRevision, opts...).ToFunc()
}
