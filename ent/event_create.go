...
func (_c *EventCreate) SetAttachmentReleasePolicy(v event.AttachmentReleasePolicy) *EventCreate {
	_c.mutation.SetAttachmentReleasePolicy(v)
	return _c
}

// SetNillableAttachmentReleasePolicy sets the "attachment_release_policy" field if the given value is not nil.
func (_c *EventCreate) SetNillableAttachmentReleasePolicy(v *event.AttachmentReleasePolicy) *EventCreate {
	if v != nil {
		_c.SetAttachmentReleasePolicy(*v)
	}
	return _c
}

// SetAttachmentReleaseCueSessionID sets the "attachment_release_cue_session_id" field.
func (_c *EventCreate) SetAttachmentReleaseCueSessionID(v int) *EventCreate {
	_c.mutation.SetAttachmentReleaseCueSessionID(v)
	return _c
}

// SetNillableAttachmentReleaseCueSessionID sets the "attachment_release_cue_session_id" field if the given value is not nil.
func (_c *EventCreate) SetNillableAttachmentReleaseCueSessionID(v *int) *EventCreate {
	if v != nil {
		_c.SetAttachmentReleaseCueSessionID(*v)
	}
	return _c
}

// SetAttachmentReleaseCueAt sets the "attachment_release_cue_at" field.
func (_c *EventCreate) SetAttachmentReleaseCueAt(v time.Time) *EventCreate {
	_c.mutation.SetAttachmentReleaseCueAt(v)
	return _c
}

// SetNillableAttachmentReleaseCueAt sets the "attachment_release_cue_at" field if the given value is not nil.
func (_c *EventCreate) SetNillableAttachmentReleaseCueAt(v *time.Time) *EventCreate {
	if v != nil {
		_c.SetAttachmentReleaseCueAt(*v)
	}
	return _c
}

// SetAttachmentReleaseRevision sets the "attachment_release_revision" field.
func (_c *EventCreate) SetAttachmentReleaseRevision(v int) *EventCreate {
...
func (_c *EventCreate) AddCompetitionResultsDraftIDs(ids ...int) *EventCreate {
...
func (_c *EventCreate) AddCompetitionResultsDrafts(v ...*CompetitionResultsDraft) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EventCreate) AddCompetitionResultStandingIDs(ids ...int) *EventCreate {
...
func (_c *EventCreate) AddCompetitionResultStandings(v ...*CompetitionResultStanding) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EventCreate) AddEventAwardsDraftIDs(ids ...int) *EventCreate {
	_c.mutation.AddEventAwardsDraftIDs(ids...)
	return _c
}

// AddEventAwardsDrafts adds the "event_awards_drafts" edges to the EventAwardsDraft entity.
func (_c *EventCreate) AddEventAwardsDrafts(v ...*EventAwardsDraft) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddEventAwardsDraftIDs(ids...)
}

// AddPrizegivingIDs adds the "prizegivings" edge to the Prizegiving entity by IDs.
func (_c *EventCreate) AddPrizegivingIDs(ids ...int) *EventCreate {
	_c.mutation.AddPrizegivingIDs(ids...)
	return _c
}

// AddPrizegivings adds the "prizegivings" edges to the Prizegiving entity.
func (_c *EventCreate) AddPrizegivings(v ...*Prizegiving) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EventCreate) AddResultsPublicationIDs(ids ...int) *EventCreate {
	_c.mutation.AddResultsPublicationIDs(ids...)
	return _c
}

// AddResultsPublications adds the "results_publications" edges to the ResultsPublication entity.
func (_c *EventCreate) AddResultsPublications(v ...*ResultsPublication) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddResultsPublicationIDs(ids...)
}

// AddResultsCorrectionIDs adds the "results_corrections" edge to the ResultsCorrection entity by IDs.
func (_c *EventCreate) AddResultsCorrectionIDs(ids ...int) *EventCreate {
	_c.mutation.AddResultsCorrectionIDs(ids...)
	return _c
}

// AddResultsCorrections adds the "results_corrections" edges to the ResultsCorrection entity.
func (_c *EventCreate) AddResultsCorrections(v ...*ResultsCorrection) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EventCreate) AddVotingTallyIDs(ids ...int) *EventCreate {
	_c.mutation.AddVotingTallyIDs(ids...)
	return _c
}

// AddVotingTallies adds the "voting_tallies" edges to the VotingTally entity.
func (_c *EventCreate) AddVotingTallies(v ...*VotingTally) *EventCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EventCreate) defaults() error {
	...
	if _, ok := _c.mutation.AttachmentReleasePolicy(); !ok {
		v := event.DefaultAttachmentReleasePolicy
		_c.mutation.SetAttachmentReleasePolicy(v)
	}
...
func (_c *EventCreate) check() error {
	...
	if _, ok := _c.mutation.AttachmentReleasePolicy(); !ok {
		return &ValidationError{Name: "attachment_release_policy", err: errors.New(`ent: missing required field "Event.attachment_release_policy"`)}
	}
	if v, ok := _c.mutation.AttachmentReleasePolicy(); ok {
	...
	if v, ok := _c.mutation.AttachmentReleaseCueSessionID(); ok {
	...
	if _, ok := _c.mutation.AttachmentReleaseRevision(); !ok {
		return &ValidationError{Name: "attachment_release_revision", err: errors.New(`ent: missing required field "Event.attachment_release_revision"`)}
	}
...
func (_c *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AttachmentReleasePolicy(); ok {
		_spec.SetField(event.FieldAttachmentReleasePolicy, field.TypeEnum, value)
		_node.AttachmentReleasePolicy = value
	}
	if value, ok := _c.mutation.AttachmentReleaseCueSessionID(); ok {
		_spec.SetField(event.FieldAttachmentReleaseCueSessionID, field.TypeInt, value)
		_node.AttachmentReleaseCueSessionID = &value
	}
	if value, ok := _c.mutation.AttachmentReleaseCueAt(); ok {
		_spec.SetField(event.FieldAttachmentReleaseCueAt, field.TypeTime, value)
		_node.AttachmentReleaseCueAt = value
	}
	...
	if nodes := _c.mutation.EventAwardsDraftsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.PrizegivingsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.ResultsPublicationsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.ResultsCorrectionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
