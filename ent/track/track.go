...
const (
	...
	DraftTable = "track_drafts"
	// DraftInverseTable is the table name for the TrackDraft entity.
	// It exists in this package in order to avoid circular dependency with the "trackdraft" package.
	DraftInverseTable = "track_drafts"
	// DraftColumn is the table column denoting the draft relation/edge.
	DraftColumn = "track_id"
	// PublishedVersionsTable is the table that holds the published_versions relation/edge.
	PublishedVersionsTable = "track_published_versions"
	// PublishedVersionsInverseTable is the table name for the TrackPublishedVersion entity.
	// It exists in this package in order to avoid circular dependency with the "trackpublishedversion" package.
	PublishedVersionsInverseTable = "track_published_versions"
	// PublishedVersionsColumn is the table column denoting the published_versions relation/edge.
	PublishedVersionsColumn = "track_id"
	// SessionDraftsTable is the table that holds the session_drafts relation/edge. The primary key declared below.
	SessionDraftsTable = "session_draft_tracks"
	...
	SessionPublishedVersionsTable = "session_published_version_tracks"
...
var (
	...
	SessionDraftsPrimaryKey = []string{"session_draft_id", "track_id"}
	...
	SessionPublishedVersionsPrimaryKey = []string{"session_published_version_id", "track_id"}
)
