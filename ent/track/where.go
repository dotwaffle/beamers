...
func EventID(v int) predicate.Track {
	return predicate.Track(sql.FieldEQ(FieldEventID, v))
}
...
func EventIDEQ(v int) predicate.Track {
	return predicate.Track(sql.FieldEQ(FieldEventID, v))
}

// EventIDNEQ applies the NEQ predicate on the "event_id" field.
func EventIDNEQ(v int) predicate.Track {
	return predicate.Track(sql.FieldNEQ(FieldEventID, v))
}

// EventIDIn applies the In predicate on the "event_id" field.
func EventIDIn(vs ...int) predicate.Track {
	return predicate.Track(sql.FieldIn(FieldEventID, vs...))
}

// EventIDNotIn applies the NotIn predicate on the "event_id" field.
func EventIDNotIn(vs ...int) predicate.Track {
	return predicate.Track(sql.FieldNotIn(FieldEventID, vs...))
}
...
func HasEventWith(preds ...predicate.Event) predicate.Track {
	return predicate.Track(func(s *sql.Selector) {
		step := newEventStep()
...
func HasDraftWith(preds ...predicate.TrackDraft) predicate.Track {
	return predicate.Track(func(s *sql.Selector) {
		step := newDraftStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasPublishedVersions() predicate.Track {
	return predicate.Track(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasPublishedVersionsWith(preds ...predicate.TrackPublishedVersion) predicate.Track {
	return predicate.Track(func(s *sql.Selector) {
