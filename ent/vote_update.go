...
func (_u *VoteUpdate) SetNillableUpdatedAt(v *time.Time) *VoteUpdate {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
func (_u *VoteUpdate) check() error {
	...
	if _u.mutation.EventCleared() && len(_u.mutation.EventIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Vote.event"`)
	}
	if _u.mutation.CompetitionCleared() && len(_u.mutation.CompetitionIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Vote.competition"`)
	}
	if _u.mutation.AccountCleared() && len(_u.mutation.AccountIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Vote.account"`)
	}
	if _u.mutation.EntryCleared() && len(_u.mutation.EntryIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Vote.entry"`)
	}
	return nil
}
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_u *VoteUpdateOne) SetNillableUpdatedAt(v *time.Time) *VoteUpdateOne {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
