...
type EventQuery struct {
	...
	withVotes                      *VoteQuery
	withVotingTallies              *VotingTallyQuery
...
func (_q *EventQuery) QueryCompetitionEntries() *CompetitionEntryQuery {
...
func (_q *EventQuery) QueryCompetitionResultsDrafts() *CompetitionResultsDraftQuery {
...
func (_q *EventQuery) QueryCompetitionResultStandings() *CompetitionResultStandingQuery {
...
// QueryPrizegivings chains the current query on the "prizegivings" edge.
func (_q *EventQuery) QueryPrizegivings() *PrizegivingQuery {
...
// QueryResultsPublications chains the current query on the "results_publications" edge.
func (_q *EventQuery) QueryResultsPublications() *ResultsPublicationQuery {
	query := (&ResultsPublicationClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryVotingKeys chains the current query on the "voting_keys" edge.
func (_q *EventQuery) QueryVotingKeys() *VotingKeyQuery {
	query := (&VotingKeyClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryVotingTallies chains the current query on the "voting_tallies" edge.
func (_q *EventQuery) QueryVotingTallies() *VotingTallyQuery {
...
func (_q *EventQuery) Clone() *EventQuery {
	...
	return &EventQuery{
		...
		withVotingTallies:              _q.withVotingTallies.Clone(),
...
func (_q *EventQuery) WithCompetitionEntries(opts ...func(*CompetitionEntryQuery)) *EventQuery {
	query := (&CompetitionEntryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithCompetitionResultsDrafts(opts ...func(*CompetitionResultsDraftQuery)) *EventQuery {
	query := (&CompetitionResultsDraftClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithCompetitionResultStandings(opts ...func(*CompetitionResultStandingQuery)) *EventQuery {
	query := (&CompetitionResultStandingClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithPrizegivings tells the query-builder to eager-load the nodes that are connected to
// the "prizegivings" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *EventQuery) WithPrizegivings(opts ...func(*PrizegivingQuery)) *EventQuery {
	query := (&PrizegivingClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithResultsPublications tells the query-builder to eager-load the nodes that are connected to
// the "results_publications" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *EventQuery) WithResultsPublications(opts ...func(*ResultsPublicationQuery)) *EventQuery {
	query := (&ResultsPublicationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithVotingKeys tells the query-builder to eager-load the nodes that are connected to
// the "voting_keys" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *EventQuery) WithVotingKeys(opts ...func(*VotingKeyQuery)) *EventQuery {
	query := (&VotingKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withVotingKeys = query
	return _q
}
...
// WithVotingTallies tells the query-builder to eager-load the nodes that are connected to
// the "voting_tallies" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *EventQuery) WithVotingTallies(opts ...func(*VotingTallyQuery)) *EventQuery {
	query := (&VotingTallyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withVotingTallies = query
	return _q
}
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withCompetitionEntries; query != nil {
		if err := _q.loadCompetitionEntries(ctx, query, nodes,
			func(n *Event) { n.Edges.CompetitionEntries = []*CompetitionEntry{} },
			func(n *Event, e *CompetitionEntry) {
	...
	if query := _q.withCompetitionResultsDrafts; query != nil {
		if err := _q.loadCompetitionResultsDrafts(ctx, query, nodes,
			func(n *Event) { n.Edges.CompetitionResultsDrafts = []*CompetitionResultsDraft{} },
			func(n *Event, e *CompetitionResultsDraft) {
	...
	if query := _q.withCompetitionResultStandings; query != nil {
		if err := _q.loadCompetitionResultStandings(ctx, query, nodes,
			func(n *Event) { n.Edges.CompetitionResultStandings = []*CompetitionResultStanding{} },
	...
	if query := _q.withPrizegivings; query != nil {
	...
	if query := _q.withResultsPublications; query != nil {
		if err := _q.loadResultsPublications(ctx, query, nodes,
	...
	if query := _q.withVotingEligibilities; query != nil {
		if err := _q.loadVotingEligibilities(ctx, query, nodes,
			func(n *Event) { n.Edges.VotingEligibilities = []*VotingEligibility{} },
			func(n *Event, e *VotingEligibility) {
				n.Edges.VotingEligibilities = append(n.Edges.VotingEligibilities, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withVotingKeys; query != nil {
	...
	if query := _q.withVotingTallies; query != nil {
		if err := _q.loadVotingTallies(ctx, query, nodes,
			func(n *Event) { n.Edges.VotingTallies = []*VotingTally{} },
			func(n *Event, e *VotingTally) { n.Edges.VotingTallies = append(n.Edges.VotingTallies, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *EventQuery) loadCompetitionEntries(ctx context.Context, query *CompetitionEntryQuery, nodes []*Event, init func(*Event), assign func(*Event, *CompetitionEntry)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(competitionentry.FieldEventID)
	}
	query.Where(predicate.CompetitionEntry(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.CompetitionEntriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadCompetitionResultsDrafts(ctx context.Context, query *CompetitionResultsDraftQuery, nodes []*Event, init func(*Event), assign func(*Event, *CompetitionResultsDraft)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(competitionresultsdraft.FieldEventID)
	}
	query.Where(predicate.CompetitionResultsDraft(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.CompetitionResultsDraftsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadCompetitionResultStandings(ctx context.Context, query *CompetitionResultStandingQuery, nodes []*Event, init func(*Event), assign func(*Event, *CompetitionResultStanding)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(competitionresultstanding.FieldEventID)
	}
...
func (_q *EventQuery) loadPrizegivings(ctx context.Context, query *PrizegivingQuery, nodes []*Event, init func(*Event), assign func(*Event, *Prizegiving)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(prizegiving.FieldEventID)
	}
...
func (_q *EventQuery) loadResultsPublications(ctx context.Context, query *ResultsPublicationQuery, nodes []*Event, init func(*Event), assign func(*Event, *ResultsPublication)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(resultspublication.FieldEventID)
	}
...
func (_q *EventQuery) loadVotingEligibilities(ctx context.Context, query *VotingEligibilityQuery, nodes []*Event, init func(*Event), assign func(*Event, *VotingEligibility)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(votingeligibility.FieldEventID)
	}
	query.Where(predicate.VotingEligibility(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.VotingEligibilitiesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadVotingKeys(ctx context.Context, query *VotingKeyQuery, nodes []*Event, init func(*Event), assign func(*Event, *VotingKey)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(votingkey.FieldEventID)
	}
...
func (_q *EventQuery) loadVotingTallies(ctx context.Context, query *VotingTallyQuery, nodes []*Event, init func(*Event), assign func(*Event, *VotingTally)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(votingtally.FieldEventID)
	}
	query.Where(predicate.VotingTally(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.VotingTalliesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
