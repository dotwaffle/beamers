...
// HasPrizegivings applies the HasEdge predicate on the "prizegivings" edge.
func HasPrizegivings() predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPrizegivingsWith applies the HasEdge predicate on the "prizegivings" edge with a given conditions (other predicates).
func HasPrizegivingsWith(preds ...predicate.Prizegiving) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newPrizegivingsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasPrizegivingCompetitions applies the HasEdge predicate on the "prizegiving_competitions" edge.
func HasPrizegivingCompetitions() predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPrizegivingCompetitionsWith applies the HasEdge predicate on the "prizegiving_competitions" edge with a given conditions (other predicates).
func HasPrizegivingCompetitionsWith(preds ...predicate.PrizegivingCompetition) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newPrizegivingCompetitionsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasResultsPublications applies the HasEdge predicate on the "results_publications" edge.
func HasResultsPublications() predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ResultsPublicationsTable, ResultsPublicationsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasResultsPublicationsWith applies the HasEdge predicate on the "results_publications" edge with a given conditions (other predicates).
func HasResultsPublicationsWith(preds ...predicate.ResultsPublication) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newResultsPublicationsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasResultsCorrections applies the HasEdge predicate on the "results_corrections" edge.
func HasResultsCorrections() predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasResultsCorrectionsWith applies the HasEdge predicate on the "results_corrections" edge with a given conditions (other predicates).
func HasResultsCorrectionsWith(preds ...predicate.ResultsCorrection) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newResultsCorrectionsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasVotingTallies applies the HasEdge predicate on the "voting_tallies" edge.
func HasVotingTallies() predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasVotingTalliesWith applies the HasEdge predicate on the "voting_tallies" edge with a given conditions (other predicates).
func HasVotingTalliesWith(preds ...predicate.VotingTally) predicate.Event {
	return predicate.Event(func(s *sql.Selector) {
		step := newVotingTalliesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
