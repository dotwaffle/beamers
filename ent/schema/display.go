...
func (Display) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("applied_urgent_notice_id").Default(0),
		field.Int("applied_urgent_notice_revision").Default(0),
		field.Int("applied_emergency_alert_id").Default(0),
		field.Int("applied_emergency_alert_revision").Default(0),
