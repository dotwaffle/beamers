...
// The AccountPreferenceFunc type is an adapter to allow the use of ordinary
// function as AccountPreference mutator.
type AccountPreferenceFunc func(context.Context, *ent.AccountPreferenceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccountPreferenceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AccountPreferenceMutation); ok {
		return f(ctx, mv)
	}
...
// The EventSlugFunc type is an adapter to allow the use of ordinary
// function as EventSlug mutator.
type EventSlugFunc func(context.Context, *ent.EventSlugMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f EventSlugFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EventSlugMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f VotingEligibilityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VotingEligibilityMutation); ok {
		return f(ctx, mv)
	}
...
// The VotingTallyFunc type is an adapter to allow the use of ordinary
// function as VotingTally mutator.
type VotingTallyFunc func(context.Context, *ent.VotingTallyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VotingTallyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VotingTallyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VotingTallyMutation", m)
}
