...
const (
	// Label holds the string label denoting the eventthemerevision type in the database.
	Label = "event_theme_revision"
	...
	EdgeEvent = "event"
	// Table holds the table name of the eventthemerevision in the database.
	Table = "event_theme_revisions"
	// EventTable is the table that holds the event relation/edge.
	EventTable = "event_theme_revisions"
...
// Columns holds all SQL columns for eventthemerevision fields.
var Columns = []string{
	FieldID,
	FieldEventID,
	FieldConfig,
...
// OrderOption defines the ordering options for the EventThemeRevision queries.
