...
func (_q *LocationQuery) QueryEvent() *EventQuery {
...
func (_q *LocationQuery) QueryDraft() *LocationDraftQuery {
	query := (&LocationDraftClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *LocationQuery) QueryPublishedVersions() *LocationPublishedVersionQuery {
	query := (&LocationPublishedVersionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *LocationQuery) QuerySessionDrafts() *SessionDraftQuery {
...
func (_q *LocationQuery) QuerySessionPublishedVersions() *SessionPublishedVersionQuery {
...
func (_q *LocationQuery) WithEvent(opts ...func(*EventQuery)) *LocationQuery {
	query := (&EventClient{config: _q.config}).Query()
...
func (_q *LocationQuery) WithDraft(opts ...func(*LocationDraftQuery)) *LocationQuery {
	query := (&LocationDraftClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *LocationQuery) WithPublishedVersions(opts ...func(*LocationPublishedVersionQuery)) *LocationQuery {
	query := (&LocationPublishedVersionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *LocationQuery) WithSessionDrafts(opts ...func(*SessionDraftQuery)) *LocationQuery {
	query := (&SessionDraftClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *LocationQuery) WithSessionPublishedVersions(opts ...func(*SessionPublishedVersionQuery)) *LocationQuery {
	query := (&SessionPublishedVersionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *LocationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Location, error) {
	...
	if query := _q.withEvent; query != nil {
		if err := _q.loadEvent(ctx, query, nodes, nil,
			func(n *Location, e *Event) { n.Edges.Event = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDraft; query != nil {
		if err := _q.loadDraft(ctx, query, nodes, nil,
			func(n *Location, e *LocationDraft) { n.Edges.Draft = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withSessionDrafts; query != nil {
		if err := _q.loadSessionDrafts(ctx, query, nodes,
			func(n *Location) { n.Edges.SessionDrafts = []*SessionDraft{} },
			func(n *Location, e *SessionDraft) { n.Edges.SessionDrafts = append(n.Edges.SessionDrafts, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *LocationQuery) loadEvent(ctx context.Context, query *EventQuery, nodes []*Location, init func(*Location), assign func(*Location, *Event)) error {
...
func (_q *LocationQuery) loadDraft(ctx context.Context, query *LocationDraftQuery, nodes []*Location, init func(*Location), assign func(*Location, *LocationDraft)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(locationdraft.FieldLocationID)
	}
	query.Where(predicate.LocationDraft(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(location.DraftColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *LocationQuery) loadPublishedVersions(ctx context.Context, query *LocationPublishedVersionQuery, nodes []*Location, init func(*Location), assign func(*Location, *LocationPublishedVersion)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Location)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(locationpublishedversion.FieldLocationID)
	}
...
func (_q *LocationQuery) loadSessionDrafts(ctx context.Context, query *SessionDraftQuery, nodes []*Location, init func(*Location), assign func(*Location, *SessionDraft)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(location.SessionDraftsTable)
		s.Join(joinT).On(s.C(sessiondraft.FieldID), joinT.C(location.SessionDraftsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(location.SessionDraftsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(location.SessionDraftsPrimaryKey[1]))
...
func (_q *LocationQuery) loadSessionPublishedVersions(ctx context.Context, query *SessionPublishedVersionQuery, nodes []*Location, init func(*Location), assign func(*Location, *SessionPublishedVersion)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Location)
	nids := make(map[int]map[*Location]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(location.SessionPublishedVersionsTable)
		s.Join(joinT).On(s.C(sessionpublishedversion.FieldID), joinT.C(location.SessionPublishedVersionsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(location.SessionPublishedVersionsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(location.SessionPublishedVersionsPrimaryKey[1]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (_q *LocationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withEvent != nil {
			_spec.Node.AddColumnOnce(location.FieldEventID)
		}
	}
