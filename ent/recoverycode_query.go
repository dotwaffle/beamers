...
func (_q *RecoveryCodeQuery) QueryAccount() *AccountQuery {
...
func (_q *RecoveryCodeQuery) WithAccount(opts ...func(*AccountQuery)) *RecoveryCodeQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
//		GroupBy(recoverycode.FieldAccountID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.RecoveryCode.Query().
//		Select(recoverycode.FieldAccountID).
//		Scan(ctx, &v)
...
func (_q *RecoveryCodeQuery) prepareQuery(ctx context.Context) error {
	...
	if err := recoverycode.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *RecoveryCodeQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*RecoveryCode, init func(*RecoveryCode), assign func(*RecoveryCode, *Account)) error {
...
func (_q *RecoveryCodeQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccount != nil {
			_spec.Node.AddColumnOnce(recoverycode.FieldAccountID)
		}
	}
