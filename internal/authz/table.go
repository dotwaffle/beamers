...
const (
	...
	noteOverrideTargetKey        = "D6: indirect Override targets are judged by the synthetic key displayOverrideTargetKey builds rather than by the Display Groups of the Displays that consume them. The draft proposes resolving the target; that both widens and narrows authority and needs a decision."
